...
class CivilSem2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val smClick = findViewById<ImageView>(R.id.sm)
        ...
        val smLabClick = findViewById<ImageView>(R.id.smlab)
